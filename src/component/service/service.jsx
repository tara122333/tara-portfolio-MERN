...
import Resume from "./tara-resume.pdf";
          ...
          <div className="flex flex-col h-full relative w-full lg:w-1/2 mb-20 lg:mb-0">
            ...
            <div className="my-5 lg:my-0 lg:w-2/3">
              <span className="text-gray-600 md:text-xl">
                Full Stack Developer with Good level of experience in web
                designing and development, producting the Quality work. You can
                see my resume on the link given below
              </span>
            </div>
            <div className="my-8 lg:my-4 flex flex-col gap-5">
              <div className="w-80 h-80">
                <img
                  src="https://c.tenor.com/tX_T48A14BwAAAAd/khaby-really.gif"
                  alt="sticker"
              ...
              <div className="flex flex-col gap-5 md:flex-row">
                ...
                <a
                  href="https://tara122333.github.io/Tara_Resume/"
                  target=" _blank"
                >
                  <button
                    className="bg-gradient-to-r border-2 border-tara-orange from-tara-yellow to-tara-orange rounded-full px-8 py-2 text-white shadow-2xl shadow-tara-yellow hover:bg-gradient-to-r
          ...
          <div className="hidden lg:flex relative w-full h-full lg:w-1/2">
            ...
            >
              <Card
                emoji={HeartEmoji}
                heading={"Front-end"}
                detail={"Html, Css, React, BootStrap, TailwindCss, Redux"}
                className="relative"
              />
            </motion.div>
            {/* second card */}
            ...
            >
              <Card
                emoji={Glasses}
                heading={"Back-end"}
                detail={"Nodejs, Express, MongoDB, Docker, AWS, MySQL"}
                className="relative"
              />
            </motion.div>
            {/* 3rd */}
            ...
            >
              <Card
                emoji={Humble}
                heading={"Programming"}
                detail={"C/C++, JavaScript, TypeScript"}
