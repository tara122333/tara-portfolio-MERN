...
const Hero = () => {
  ...
  return (
    <>
        <div className='px-4 lg:container lg:mx-auto lg:px-16 flex flex-col lg:flex-row lg:mb-48 w-full lg:py-10' id='Navbar'>
            <div className='flex flex-col h-full relative w-full lg:w-1/2 lg:mb-40 py-5'>
                ...
                <div className='hidden lg:flex w-1/2 justify-center items-center h-screen scale-75 relative -top-20 bg-purple-200 rounded-3xl'>
                    <div>
                        <img src={hero} alt="vector" className='w-full h-full relative -top-12'/>
                    </div>
                </div>
            </div>
    </>
