...
const Projects = (props) => {
  return (
    <div className="shadow-lg rounded-lg w-full md:w-96 container mx-auto lg:flex lg:flex-col lg:mx-0 lg:hover:shadow-2xl">
      ...
      <div className="py-5 px-3 w-full flex flex-col justify-between h-full">
        <div className="flex flex-col">
          <h1 className="text-xl text-tara-black">{props.title}</h1>
          <h3 className="text-base text-gray-500 ">{props.description}</h3>
        </div>
        <div className="flex flex-col">
          <div className="flex flex-col gap-2">
            <h3 className="text-base text-tara-black font-medium">Technology used</h3>
            <div className="flex flex-wrap gap-2">
              {props.skills.map((item) => (
                <h1 className="px-3 bg-green-700 rounded-md text-white">
                  {item}
                </h1>
              ))}
            </div>
